...
{
    /// <summary>
    /// Editor for <see cref="Spline2DSimple"/> which allows for adjusting control points and control point variance as required.
    /// </summary>
    [CustomEditor(typeof(Spline2DVariance))]
    public class Spline2DVarianceEditor : UnityEditor.Editor
    {
        ...
        protected virtual ISimpleSpline2DVarianceEditor Spline
        {
            get => m_spline;
            set => m_spline = value;
        }
        ...
        private ISimpleSpline2DVarianceEditor m_spline = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                Spline = target as ISimpleSpline2DVarianceEditor;
                m_editing = false;
            ...
            if(!m_editing)
            {
                ...
                // Draw Zebra Stripes - This helps to debug issues where the spline don't match up correctly which can happen when
        ...
        /// <summary>
        /// Check if the spline editor should allow the user to change the current spline
        /// </summary>
        /// <param name="index">index that will be modified</param>
        /// <param name="pointType">point type that will be modified</param>
        /// <returns>true if user should be allowed to edit</returns>
