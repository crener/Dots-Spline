...
namespace Crener.Spline._2DVariance.Jobs
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// If no variance is required <see cref="BezierSpline2DPointJob"/> should be used with the accompanying simple spline setup in scene.
    /// </remarks>
    [BurstCompile]
    public struct BezierSpline2DVariancePointJob : IJob
    {
        [ReadOnly]
