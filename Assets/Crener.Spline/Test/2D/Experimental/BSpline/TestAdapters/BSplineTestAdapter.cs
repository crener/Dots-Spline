...
namespace Crener.Spline.Test._2D.Experimental.BSpline.TestAdapters
{
    public abstract class BSplineTestAdapter : SelfCleanUpTestSet
    {
        ...
        public void Point2()
        {
            ...
            TestHelpers.CheckFloat2(new float2(0.5f, 0f), testSpline.Get2DPointWorld(0f));
        ...
        public void Point3()
        {
            ...
            TestHelpers.CheckFloat2(new float2(1.25f, 0f), testSpline.Get2DPointWorld(0f));
            TestHelpers.CheckFloat2(new float2(2.8125f, 0f), testSpline.Get2DPointWorld(0.25f));
            TestHelpers.CheckFloat2(new float2(5f, 0f), testSpline.Get2DPointWorld(0.5f));
            float2 max = new float2(8.75f, 0f);
            TestHelpers.CheckFloat2(max, testSpline.Get2DPointWorld(1f));
            TestHelpers.CheckFloat2(max, testSpline.Get2DPointWorld(1.5f));
            TestHelpers.CheckFloat2(max, testSpline.Get2DPointWorld(5f));
        }
        ...
        public void Update2()
        {
            ...
            TestHelpers.CheckFloat2(b, testSpline.GetControlPoint(1, SplinePoint.Point));
            TestHelpers.CheckFloat2(new float2(1.5f, 0f), testSpline.Get2DPointWorld(1f));
            TestHelpers.CheckFloat2(c, testSpline.GetControlPoint(2, SplinePoint.Point));

            //update 0 point position
            testSpline.UpdateControlPointLocal(0, new float2(0.5f, 1f), SplinePoint.Point);
            TestHelpers.CheckFloat2(new float2(0.75f, 0.5f), testSpline.Get2DPointWorld(0f));
            ...
            testSpline.UpdateControlPointLocal(2, new float2(2f, 1f), SplinePoint.Point);
            TestHelpers.CheckFloat2(new float2(1.5f, 1f), testSpline.Get2DPointWorld(1f));
