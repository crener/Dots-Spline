...
namespace Crener.Spline.Test._3DPlane.LinearCubicPlain._2D
{
    ...
    /// </summary>
    public class JobLinearCubicPlane2D : LinearCubicBaseTest2DPlaneAdapter
    {
    ...
    public class JobLoopingLinearCubicPlane2D : BaseLoopingTests2D
    {
    ...
    public class JobArkLinearCubicPlane2D : BaseArkTests2D
    {
